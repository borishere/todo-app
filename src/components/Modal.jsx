...
import { setModal } from '../state/actionCreators';
...
function Modal() {
    ...
    return (
        <React.Fragment>
            <button onClick={() => dispatch(setModal(true))}>show modal</button>
            {
                state.modalOpened && (
                    <div className='modal'>
                        <div className='modal-body'>
                            <button className='modal-close' onClick={() => { dispatch(setModal(false)) }}>&#9932;</button>
                            <h1>Modal header</h1>
